...
variables["SR"].append(variable('mjj', 'Invarant mass JJ',  7, array("f", [500., 600., 800., 1000., 1400., 1800., 2200., 3000.])))
...
variables["CR_non_prompt"].append(variable('mjj', 'Invarant mass JJ',  8, array("f", [0., 150., 300., 500., 700., 1000., 1400., 1800., 3000.])))
...
variables["CR_ttbar"].append(variable('mjj', 'Invarant mass JJ',  9, array("f", [0., 150., 300., 500., 700., 1000., 1400., 1800., 2200., 3000.])))
...
variables["CR_wrong_sign"].append(variable('mjj', 'Invarant mass JJ',  9, array("f", [0., 150., 300., 500., 700., 1000., 1400., 1800., 2200., 3000.])))
